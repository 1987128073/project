...
class ParseData(object):
    ...
    def parse_itemlist(self):
        ...
        while 1:
            ...
            res = collection.find({'is_parsed': False})
            ...
            for data in res:
                ...
                #     live_pro_anchor = self.save_db['live_pro_anchor'].find_one({'_id': f'{item_id}:{liveId}'})
                #     if not live_pro_anchor:
                #         data = {
                #             '_id':  f'{item_id}:{liveId}',  # 商品id
                #             'itme_id': item_id,
                #             'live_id': liveId,
                #             'anchor_id': anchor_id,
